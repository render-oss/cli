...
import (
	...
	externalRef8 "github.com/renderinc/render-cli/pkg/client/notifications"
	externalRef9 "github.com/renderinc/render-cli/pkg/client/postgres"
)
...
func (t EventTypeParam) AsExternalRef3EventType() (externalRef3.EventType, error) {
	var body externalRef3.EventType
	err := json.Unmarshal(t.union, &body)
	return body, err
}
